...
service IntegrationContent {
  ...
  entity IntegrationPackages {
    key Id                                : LargeString not null;
        ...
        IntegrationDesigntimeArtifacts    : Composition of many IntegrationDesigntimeArtifacts
                                              on IntegrationDesigntimeArtifacts.PackageId = Id;
        ValueMappingDesigntimeArtifacts   : Composition of many ValueMappingDesigntimeArtifacts
                                              on ValueMappingDesigntimeArtifacts.PackageId = Id;
        MessageMappingDesigntimeArtifacts : Composition of many MessageMappingDesigntimeArtifacts
                                              on MessageMappingDesigntimeArtifacts.PackageId = Id;
  ...
  @cds.external: true
  action DeployIntegrationDesigntimeArtifact(Id: LargeString not null,
                                             Version: LargeString not null)                 returns IntegrationDesigntimeArtifacts;

  @cds.external: true
  action IntegrationDesigntimeArtifactSaveAsVersion(Id: LargeString not null,
                                                    SaveAsVersion: LargeString not null)    returns IntegrationDesigntimeArtifacts;

  @cds.external: true
  action CopyIntegrationPackage(Id: LargeString not null,
                                ImportMode: LargeString,
                                Suffix: LargeString)                                        returns IntegrationPackages;

  @cds.external: true
  action DeployValueMappingDesigntimeArtifact(Id: LargeString not null,
                                              Version: LargeString not null)                returns ValueMappingDesigntimeArtifacts;

  @cds.external: true
  action ValueMappingDesigntimeArtifactSaveAsVersion(Id: LargeString not null,
                                                     SaveAsVersion: LargeString not null)   returns ValueMappingDesigntimeArtifacts;

  @cds.external: true
  action UpsertValMaps(Id: LargeString not null,
                       Version: LargeString not null,
                       ...
                       IsConfigured: Boolean not null)                                      returns ValMaps;

  @cds.external: true
  action DeleteValMaps(Id: LargeString not null,
                       Version: LargeString not null,
                       SrcAgency: LargeString not null,
                       SrcId: LargeString not null,
                       TgtAgency: LargeString not null,
                       TgtId: LargeString not null)                                         returns LargeString;

  @cds.external: true
  action UpdateDefaultValMap(Id: LargeString not null,
                             Version: LargeString not null,
                             SrcAgency: LargeString not null,
                             SrcId: LargeString not null,
                             TgtAgency: LargeString not null,
                             ...
                             IsConfigured: Boolean not null)                                returns DefaultValMaps;

  @cds.external: true
  action DeployIntegrationAdapterDesigntimeArtifact(Id: LargeString not null)               returns IntegrationAdapterDesigntimeArtifacts;

  @cds.external: true
  action DeployMessageMappingDesigntimeArtifact(Id: LargeString not null,
                                                Version: LargeString not null)              returns MessageMappingDesigntimeArtifacts;

  @cds.external: true
  action MessageMappingDesigntimeArtifactSaveAsVersion(Id: LargeString not null,
                                                       SaveAsVersion: LargeString not null) returns MessageMappingDesigntimeArtifacts;

  @cds.external: true
  action DeployScriptCollectionDesigntimeArtifact(Id: LargeString not null,
                                                  Version: LargeString not null)            returns ScriptCollectionDesigntimeArtifacts;
};
